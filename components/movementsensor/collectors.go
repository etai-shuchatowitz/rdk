...
func newLinearVelocityCollector(resource interface{}, params data.CollectorParams, tagger data.Tagger) (data.Collector, error) {
...
// with the same MethodMetadata it will panic.
func newAngularVelocityCollector(resource interface{}, params data.CollectorParams, tagger data.Tagger) (data.Collector, error) {
	ms, err := assertMovementSensor(resource)
	if err != nil {
		return nil, err
	}
...
// with the same MethodMetadata it will panic.
func newCompassHeadingCollector(resource interface{}, params data.CollectorParams, tagger data.Tagger) (data.Collector, error) {
	ms, err := assertMovementSensor(resource)
	if err != nil {
		return nil, err
	}
...
// with the same MethodMetadata it will panic.
func newLinearAccelerationCollector(resource interface{}, params data.CollectorParams, tagger data.Tagger) (data.Collector, error) {
	ms, err := assertMovementSensor(resource)
	if err != nil {
		return nil, err
	}
...
// with the same MethodMetadata it will panic.
func newOrientationCollector(resource interface{}, params data.CollectorParams, tagger data.Tagger) (data.Collector, error) {
	ms, err := assertMovementSensor(resource)
	if err != nil {
		return nil, err
	}
